...
export const metadata: Metadata = {
  ...
  description:
    "Learn about OS TrustTech, our mission, team and company milestones",
};
...
export default async function AboutPage({ params }: PageProps) {
  ...
  const aboutTranslations = {
    ...
    description:
      ...
      "We're a team of passionate technologists dedicated to crafting innovative software solutions.",
    philosophy:
      translations.about?.philosophy ||
      "At OS TrustTech, we believe in combining technical excellence with a deep understanding of our clients' business needs. Our solutions are built not just to solve today's challenges, but to adapt and grow with your business tomorrow.",
    guiding_principle:
      translations.about?.guiding_principle ||
      "Building trust through technology excellence.",
    guiding_principle_label:
      translations.about?.guiding_principle_label || "Our Guiding Principle",
    core_values: {
      title: translations.about?.core_values?.title || "Our Core Values",
      excellence: {
        title:
          translations.about?.core_values?.excellence?.title || "Excellence",
        description:
          translations.about?.core_values?.excellence?.description ||
          "We are committed to delivering the highest quality solutions that exceed expectations.",
      },
      innovation: {
        title:
          translations.about?.core_values?.innovation?.title || "Innovation",
        description:
          translations.about?.core_values?.innovation?.description ||
          "We embrace new technologies and approaches to solve complex challenges.",
      },
      reliability: {
        title:
          translations.about?.core_values?.reliability?.title || "Reliability",
        description:
          translations.about?.core_values?.reliability?.description ||
          "Our clients trust us for our consistency, dependability and transparency.",
      },
      growth: {
        title: translations.about?.core_values?.growth?.title || "Growth",
        description:
          translations.about?.core_values?.growth?.description ||
          "We believe in continuous improvement and helping our clients and team grow.",
      },
    },
    technology: {
      title: translations.about?.technology?.title || "Our Technology Approach",
      description:
        translations.about?.technology?.description ||
        "We combine the latest technologies with proven methodologies to deliver exceptional results that stand the test of time.",
      frontend: {
        title:
          translations.about?.technology?.frontend?.title ||
          "Frontend Development",
        description:
          translations.about?.technology?.frontend?.description ||
          "We employ modern JavaScript frameworks and responsive design techniques to create fast, intuitive, and engaging user experiences across all devices and platforms.",
        tags: translations.about?.technology?.frontend?.tags || [
          "Modern Frameworks",
          "Responsive Design",
          "Interactive UI",
        ],
      ...
      backend: {
        title:
          translations.about?.technology?.backend?.title ||
          "Backend Development",
        description:
          translations.about?.technology?.backend?.description ||
          "Our server-side solutions utilize scalable architectures, efficient database design, and robust API development to power high-performance applications.",
        tags: translations.about?.technology?.backend?.tags || [
      ...
      cloud: {
        title:
          translations.about?.technology?.cloud?.title ||
          "Cloud & Infrastructure",
        description:
          translations.about?.technology?.cloud?.description ||
          "We leverage cloud-native technologies and containerization to create deployments that are secure, scalable, and cost-effective for businesses of all sizes.",
        tags: translations.about?.technology?.cloud?.tags || [
          "Cloud-Native",
          "Containerization",
          "Secure Deployment",
        ],
      ...
      practices: {
        title:
          translations.about?.technology?.practices?.title ||
          "Development Practices",
        description:
          translations.about?.technology?.practices?.description ||
          "Our workflow incorporates CI/CD pipelines, automated testing, and agile methodologies to ensure quality, reliability, and rapid delivery of solutions.",
        tags: translations.about?.technology?.practices?.tags || [
          "CI/CD Pipelines",
          "Automated Testing",
          "Agile Methodology",
        ],
    ...
    mission: {
      ...
      description:
        ...
        "To deliver high-quality software solutions that drive business growth and technological innovation",
    },
    team: {
    ...
    milestones: {
      ...
      description:
        translations.about?.milestones?.description ||
  ...
  return (
    <div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(to bottom, var(--background), var(--bg-muted))",
        }}
      >
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="max-w-2xl mx-auto lg:mr-0">
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative mt-12">
                    <blockquote
                      className="text-2xl italic font-medium pl-6 border-l-4"
                      style={{
                        color: "var(--accent)",
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ color: "var(--text-secondary)" }}
                      >
                        — {aboutTranslations.guiding_principle_label}
                      </div>
                    </blockquote>
                  </div>
                </div>
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div
                className="relative z-10 bg-gradient-to-br rounded-xl shadow-xl p-8 overflow-hidden"
                style={{
              ...
              >
                <h3
                  ...
                  style={{ color: "var(--text-primary)" }}
                >
                  {aboutTranslations.core_values.title}
                </h3>
                    ...
                    <div className="flex items-start mb-3">
                      ...
                      <div>
                        <h4
                          ...
                          style={{ color: "var(--text-primary)" }}
                        >
                          {aboutTranslations.core_values.excellence.title}
                        </h4>
                        <p
                          className="text-sm"
                          style={{ color: "var(--text-secondary)" }}
                        >
                          {aboutTranslations.core_values.excellence.description}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start mb-3">
                      ...
                      <div>
                        <h4
                          ...
                          style={{ color: "var(--text-primary)" }}
                        >
                          {aboutTranslations.core_values.innovation.title}
                        </h4>
                        <p
                          className="text-sm"
                          style={{ color: "var(--text-secondary)" }}
                        >
                          {aboutTranslations.core_values.innovation.description}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start mb-3">
                      ...
                      <div>
                        <h4
                          ...
                          style={{ color: "var(--text-primary)" }}
                        >
                          {aboutTranslations.core_values.reliability.title}
                        </h4>
                        <p
                          className="text-sm"
                          style={{ color: "var(--text-secondary)" }}
                        >
                          {
                            aboutTranslations.core_values.reliability
                              .description
                          }
                        </p>
                      </div>
                    ...
                    <div className="flex items-start mb-3">
                      ...
                      <div>
                        <h4
                          ...
                          style={{ color: "var(--text-primary)" }}
                        >
                          {aboutTranslations.core_values.growth.title}
                        </h4>
                        <p
                          className="text-sm"
                          style={{ color: "var(--text-secondary)" }}
                        >
                          {aboutTranslations.core_values.growth.description}
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      >
        {/* Decorative elements */}
        <div
          className="absolute top-0 right-0 w-1/3 h-96 opacity-10"
          style={{
            background:
        ...
        ></div>
        <div
          className="absolute bottom-0 left-0 w-1/3 h-96 opacity-10"
          style={{
            background:
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div
              className="p-10 rounded-2xl shadow-xl mx-auto relative z-20"
              style={{
                backgroundColor: "var(--bg-card)",
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="text-left">
                  ...
                  <h3
                    ...
                    style={{ color: "var(--accent)" }}
                  >
                    {aboutTranslations.technology.frontend.title}
                  </h3>
                  <p
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    {aboutTranslations.technology.frontend.tags.map(
                ...
                <div className="text-left">
                  ...
                  <h3
                    ...
                    style={{ color: "var(--accent)" }}
                  >
                    {aboutTranslations.technology.backend.title}
                  </h3>
                  <p
                    className="text-lg leading-relaxed"
                    style={{ color: "var(--text-secondary)" }}
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    {aboutTranslations.technology.backend.tags.map(
                      (tag: string, index: number) => (
                        <span
                          key={index}
                          className="px-4 py-2 rounded-full text-sm font-medium"
              ...
              <div
                className="h-px w-full my-12 opacity-20"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="text-left">
                  ...
                  <h3
                    ...
                    style={{ color: "var(--accent)" }}
                  >
                    {aboutTranslations.technology.cloud.title}
                  </h3>
                  <p
                    className="text-lg leading-relaxed"
                    style={{ color: "var(--text-secondary)" }}
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    {aboutTranslations.technology.cloud.tags.map(
                      (tag: string, index: number) => (
                        <span
                          key={index}
                          className="px-4 py-2 rounded-full text-sm font-medium"
                ...
                <div className="text-left">
                  ...
                  <h3
                    ...
                    style={{ color: "var(--accent)" }}
                  >
                    {aboutTranslations.technology.practices.title}
                  </h3>
                  <p
                    className="text-lg leading-relaxed"
                    style={{ color: "var(--text-secondary)" }}
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    {aboutTranslations.technology.practices.tags.map(
                      (tag: string, index: number) => (
                        <span
                          key={index}
                          className="px-4 py-2 rounded-full text-sm font-medium"
      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {aboutTranslations.team.members.map(
              (
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, var(--accent-hover), var(--accent))",
                transform: "translateX(-50%)",
              }}
            ></div>

            <div className="space-y-16">
              {aboutTranslations.milestones.items.map(
                (
                  milestone: {
                    year: string;
                    title: string;
