  ...
  return (
    ...
    >
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        ></div>
        <div
          className={`absolute inset-0 bg-[url('/images/grid.svg')] ${
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            >
              {translations.home.solutions?.description ||
                "We combine cutting-edge technologies with proven methodologies to deliver innovative solutions that drive business growth."}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            >
              <div
                className={`absolute inset-0 rounded-2xl transform rotate-1 group-hover:rotate-2 transition-transform duration-300 opacity-0 group-hover:opacity-10 blur ${
              ...
              >
                ...
                >
                  {translations.home.solutions?.items?.custom?.title ||
                ...
                >
                  {translations.home.solutions?.items?.custom?.description ||
                    "Tailored solutions that address your specific business challenges and requirements."}
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    ...
                    {translations.home.solutions?.items?.custom
                      ?.features?.[0] || "Enterprise Solutions"}
                  </li>
                </ul>
                <Link
                ...
                >
                  {translations.home.solutions?.items?.custom?.learnMore ||
                    "Learn More"}
            ...
            >
              ...
              >
                ...
                >
                  {translations.home.solutions?.items?.webMobile?.title ||
                ...
                >
                  {translations.home.solutions?.items?.webMobile?.description ||
                    "Cross-platform applications that provide seamless user experiences across all devices."}
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    <svg
                    ...
                    {translations.home.solutions?.items?.webMobile
                      ?.features?.[0] || "Progressive Web Apps"}
                  </li>
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    <svg
                      className="w-6 h-6 mr-3 text-purple-600 dark:text-purple-400"
                  ...
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    ...
                    {translations.home.solutions?.items?.webMobile
                      ?.features?.[2] || "Responsive Web Design"}
                  </li>
                </ul>
                <Link
                ...
                >
                  {translations.home.solutions?.items?.webMobile?.learnMore ||
                    "Learn More"}
                  <FiArrowRight className="ml-2 transform group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            ...
            >
              ...
              >
                ...
                >
                  {translations.home.solutions?.items?.ai?.title ||
                    "AI & Data Analytics"}
                </h3>
                <p
                  className={
                ...
                >
                  {translations.home.solutions?.items?.ai?.description ||
                    "Leverage the power of AI and big data to gain insights and make data-driven decisions."}
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    <svg
                      className="w-6 h-6 mr-3 text-emerald-600 dark:text-emerald-400"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                      <path
                    ...
                    {translations.home.solutions?.items?.ai?.features?.[0] ||
                  ...
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    ...
                    {translations.home.solutions?.items?.ai?.features?.[1] ||
                  ...
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    ...
                    {translations.home.solutions?.items?.ai?.features?.[2] ||
                ...
                >
                  {translations.home.solutions?.items?.ai?.learnMore ||
                    "Learn More"}
                  <FiArrowRight className="ml-2 transform group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          ...
          >
            ...
            >
              {translations.home.projects?.description ||
            ...
            >
              ...
              >
                ...
                <div className="p-8">
                  ...
                  >
                    {translations.projects?.projects?.mias?.title ||
                      "Health Tracker"}
                  </h3>
                  <p
                    className={
            ...
            >
              ...
              >
                {translations.home.about?.description ||
                  "OS TrustTech is a leading software development company committed to delivering innovative solutions that drive business transformation and growth."}
              </p>
              ...
              <div className="space-y-6 mb-8">
                <div className="group relative">
                  ...
                  ></div>
                  <div
                    className={`relative rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ${
                      isDarkMode
                        ? "bg-gray-800 border-gray-700"
                        : "bg-white border border-gray-100"
                    }`}
                  >
                    <div className="flex items-start">
                      <div className="flex-shrink-0">
                        <div
                          className={`w-12 h-12 rounded-xl flex items-center justify-center text-white transform group-hover:scale-110 transition-transform duration-300 ${
                            isDarkMode ? "bg-blue-500" : "bg-blue-600"
                          }`}
                        >
                      ...
                      <div className="ml-4">
                        ...
                        >
                          {translations.home.about?.cards?.mission?.title ||
                            "Our Mission"}
                        </h3>
                        <p
                          className={
                        ...
                        >
                          {translations.home.about?.cards?.mission
                            ?.description ||
                            "To empower businesses with cutting-edge technology solutions that solve complex challenges and create lasting value."}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        >
                          {translations.home.about?.cards?.values?.title ||
                            "Our Values"}
                        </h3>
                        <p
                          className={
                        ...
                        >
                          {translations.home.about?.cards?.values
                            ?.description ||
                            "We prioritize innovation, quality, transparency, and client satisfaction in everything we do."}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        >
                          {translations.home.about?.cards?.commitment?.title ||
                            "Our Commitment"}
                        </h3>
                        <p
                          className={
                        ...
                        >
                          {translations.home.about?.cards?.commitment
                            ?.description ||
                            "We're committed to building long-term partnerships and delivering solutions that exceed expectations."}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="relative h-[600px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-10">
                  ...
                  <h3 className="text-4xl font-bold text-white mb-6">
                    {translations.home.about?.excellence?.title ||
                      "Years of Excellence"}
                  </h3>
                  <p className="text-xl text-white/90 mb-12">
                    {translations.home.about?.excellence?.description ||
                      "With over 5 years in the industry, we've delivered hundreds of successful projects across various sectors."}
                  </p>
                  ...
                  <div className="grid grid-cols-2 gap-8 w-full max-w-lg">
                    <div className="group relative">
                      ...
                      <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20">
                        ...
                        <div className="text-white/90">
                          {translations.home.about?.excellence?.stats?.team ||
                            "Team Members"}
                        </div>
                      </div>
                    </div>
                    <div className="group relative">
                      ...
                      <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20">
                        ...
                        <div className="text-white/90">
                          {translations.home.about?.excellence?.stats
